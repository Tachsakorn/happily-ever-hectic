  ...
  levels: [
    {
      ...
      guests: [
        ...
        guest('friend-4', 'Friend', 'party-animal', 'friends', 104, gift),
        guest('neighbour-2', 'Neighbour', 'regular', 'neighbours', 116),
      ],
      disasterIds: ['spilled-drink', 'leaning-cake', 'dj-glitch', 'loose-puppy', 'guest-argument'],
      moments: [
        { momentId: 'toast', at: 60 },
        { momentId: 'cake-cutting', at: 150 },
      ],
      kitchen: { burners: 3, cookSeconds: 6 },
      starScores: [1650, 2600, 3300],
      coinReward: 400,
